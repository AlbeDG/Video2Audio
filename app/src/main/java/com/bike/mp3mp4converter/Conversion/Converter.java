...
import static com.bike.mp3mp4converter.Conversion.AfterConversion.AfterConversionActivity.STRING_EXTRA_NAME;
...
import com.bike.mp3mp4converter.Conversion.AfterConversion.AfterConversionActivity;
...
public class Converter {
    ...
    public Converter(ConvertActivity activity, AudioFileFormat audioFileFormat, Uri uri) throws Exception {
        this.activity = activity;
        this.audioFileFormat = audioFileFormat;
        this.uri = uri;
        this.filePath = RealPathUtil.getRealPath(activity, uri);
    ...
    boolean checkFileFormat() {
        try {
            videoFileFormat = VideoFileFormat.fromString(fileExtension());
